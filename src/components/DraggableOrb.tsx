      ...
      >
        ...
        {!isOpen && (
          <motion.button
            ...
            className="w-12 h-12 rounded-full flex items-center justify-center shadow-[0_4px_14px_rgba(37,211,102,0.4)] cursor-pointer text-white bg-[#25D366] hover:shadow-[0_0_25px_rgba(37,211,102,0.8)] transition-all duration-300"
          >
