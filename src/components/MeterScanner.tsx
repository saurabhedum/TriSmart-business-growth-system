  ...
  return (
    ...
    >
             ...
             <AnimatePresence>
               {isAnalyzing && (
                 <motion.div 
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="absolute inset-0 bg-accent/20 backdrop-blur-[2px] rounded-2xl flex flex-col items-center justify-center"
                 >
      ...
      <div className="mt-8 text-center text-white/60 max-w-sm">
        ...
        <p className="text-xs mt-1">Point your camera at a water or electric meter and press the shutter button to automatically extract the reading.</p>
      </div>
    </motion.div>
  );
}
